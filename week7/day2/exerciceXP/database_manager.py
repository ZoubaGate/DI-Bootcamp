...
def create_database(dst_file="myfileObject.json"):
    data = [
        {
            "ProductId":"HT-1000",
            "Category":"Laptops",
    ...
    with open(dst_file,'w') as fiche:
        json.dump(data,fiche)
        
        
def load_database(dst_file="myfileObject.json"):
    with open(dst_file,'r') as fiche:
